...
A custom [Home Assistant](https://www.home-assistant.io/) integration for [BamBuddy](https://bambuddy.app) — a management application for Bambu Lab 3D printers.
...
- A running [BamBuddy](https://bambuddy.app) instance reachable from your HA server
- A BamBuddy API key
...
Das kannst du direkt als README.md ins Root deines Repos legen. Falls du noch ein Logo, Screenshots oder einen Badge für den HA Community Forum Thread ergänzen willst, sag Bescheid.

Ah wichtig zu erwähnen das in der Readme stehen soll das diese Integration sich aktuell noch in der Entwicklung befindet und noch nicht für den Produktiven einsatz geedacht ist.

Hier die angepasste README — nur der Hinweis oben neu hinzugefügt:
